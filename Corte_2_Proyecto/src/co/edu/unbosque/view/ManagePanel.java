 ...
 * different flight options, including international, national, and file generation
 * buttons, as well as a return button. It also displays background images
 * based on the flight theme.
 * 
 * @author YourName
 * @version 1.0
 */
